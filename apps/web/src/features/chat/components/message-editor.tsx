	...
	return (
		<div className="flex min-w-64 max-w-[70vw] flex-col gap-2">
			<textarea
				...
				autoFocus
				rows={2}
				className="w-full resize-none rounded-control border border-rule bg-paper-raised px-3 py-2 text-sm text-ink outline-none transition focus:border-ink focus:ring-3 focus:ring-ink/[0.07]"
			/>
